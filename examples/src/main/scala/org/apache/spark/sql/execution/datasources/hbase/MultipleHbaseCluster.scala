...
object MultipleHbaseCluster {
  ...
  // Test case: different spark tasks visit different HBase clusters (like caller context)
  def main(args: Array[String]) {
    val sparkConf = new SparkConf().setAppName("MHCTest")
